...
- (void)kTouchUpInside{
    ...
    if (self.delegate || [self.delegate respondsToSelector:@selector(kSelectActionWithControl:IsSelected:)]) {
        [self.delegate kSelectActionWithControl:self IsSelected:cs];
    }
}
